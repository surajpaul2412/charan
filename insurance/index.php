...
<body>
    <section class="d-block mx-auto" style="max-width: 450px;">
        ...
        <div class="px-3 pb-4 mb-5">
            ...
            <div class="content text-dark pt-2">
                ...
                <div class="mt-4">
                    ...
                    <div class="row font-weight-bold" align="center">
                        <div class="col-6 mt-3">
                            <img src="images/new/discount.png" class="mb-2" width="30%"><br>
                            भारी वर्षा एवं शीत लेहेर में सुरक्षा
                        </div>
                        <div class="col-6 mt-3">
                            <img src="images/new/peace-day.png" class="mb-2" width="30%"><br>
                            21 दिनों का बीमा कवर
                        </div>
                        <div class="col-6 mt-3">
                            <img src="images/new/wheat.png" class="mb-2" width="30%"><br>
                            देहात की GAPL गेहूं बीज की सभी किस्मों पर लागू
                        </div>
                        <div class="col-6 mt-3">
                            <img src="images/new/money-bag.png" class="mb-2" width="30%"><br>
                ...
                <div class="mt-5">
                    ...
                    <div class="row font-weight-bold" align="center">
                        <div class="col-6 mt-3">
                            <img src="images/new/time-management.png" class="mb-2" width="30%"><br>
                            अधिकतम एवं औसत तापमान और भारी वर्षा में कवर
                        </div>
                        <div class="col-6 mt-3">
                            <img src="images/new/percent.png" class="mb-2" width="30%"><br>
        ...
        <footer class="px-3 pb-2 w-100 bg-white" style="max-width: 450px;position: fixed; bottom: 0%;"  >
            <a class="btn w-100  text-white py-2" href="insurance-detail.php" style="background-color: #128141;">
