...
<body>
    <section class="d-block mx-auto bg-white" style="max-width: 500px;height: 100vh;">
        <section class="container">
            ...
            <div align="center">
                <img src="images/thankyou.png" class="d-block mx-auto border-rounded" width="100%">
            </div>
            ...
            <div class="mt-4 pb-5">
                ...
                <div class="pt-3" data-sheetdb-url="https://sheetdb.io/api/v1/jf0q91ym7w53a" data-sheetdb-limit="10" data-sheetdb-search="pincode[]=>=<?php echo $_SESSION['pincode']-100; ?>&pincode[]=<=<?php echo $_SESSION['pincode']+100; ?>&state=<?php echo $_SESSION['state']; ?>">
                    <hr>
                    <div class="row align-items-center">
                        <div class="col-md-12 col-12" align="left">
                            <div class="font-weight-600 text-dark">{{partner}}</div>
                            <div>
                                <span class="font-weight-600 text-dark">Center Id :</span> {{partner_id}} 
                            </div>
                            <div>
                            ...
                            <div>
                                <a href="tel:{{primary_contact_numbers}}" class="btn btn-white text-dark mt-2">
                                    <img src='img/call.png' width='26px' class='pr-2 py-1'> अभी कॉल करें
                                </a>
                            </div>
                        </div>
                    </div>
